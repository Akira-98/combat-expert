...
export const COMMENT_AUTH_MESSAGE_PREFIX: string
export const COMMENT_AUTH_NONCE_TTL_MS: number
export const COMMENT_AUTH_SESSION_TTL_MS: number
...
export function buildCommentAuthMessage(params: {
  address: string
  nonce: string
  issuedAt: string
}): string
