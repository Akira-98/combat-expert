            ...
            <h1 className="m-0">
              {onTitleClick ? (
                <button
                  ...
                  className="m-0 cursor-pointer border-0 bg-transparent p-0 text-left"
                  onClick={onTitleClick}
                  type="button"
                >
                  <img alt="" className={logoClass} src="/logo.png" />
                </button>
              ) : (
                <img alt={t('app.title')} className={logoClass} src="/logo.png" />
              )}
            </h1>
          </div>
        </div>
