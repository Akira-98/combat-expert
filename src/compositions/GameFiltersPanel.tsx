...
export function GameFiltersPanel({
  ...
  return (
    <section className="sticky top-[calc(env(safe-area-inset-top)+72px)] z-20 border-b border-slate-200/80 bg-slate-100/95 px-2.5 pb-2.5 pt-1.5 backdrop-blur md:static md:mt-4 md:rounded-xl md:border md:bg-white md:p-3 md:backdrop-blur-none">
