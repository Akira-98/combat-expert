...
export function BetslipFreebetSection({
  ...
  return (
    <button
      ...
      className="inline-flex h-10 w-full items-center justify-center rounded-full bg-[linear-gradient(135deg,color-mix(in_oklab,var(--app-accent)_70%,white)_0%,var(--app-accent)_58%,color-mix(in_oklab,var(--app-accent)_72%,black)_100%)] px-4 text-sm font-bold text-white shadow-[0_0_0_1px_color-mix(in_srgb,var(--app-accent)_34%,transparent),0_8px_18px_-14px_var(--app-accent)] transition hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-60"
      disabled={isDisabled}
