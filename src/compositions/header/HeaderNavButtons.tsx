...
export function HeaderNavButtons({ onGuideClick, onRankingClick, onWalletClick }: HeaderNavButtonsProps) {
  ...
  return (
    <>
      <button aria-label="입출금" className={navButtonClass} onClick={onWalletClick} title="입출금" type="button">
