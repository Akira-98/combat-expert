...
function buildEventRow(req) {
  ...
  return {
    row: {
      ...
      is_approve_required: asBoolean(body.isApproveRequired),
      approve_is_pending: asBoolean(body.approveIsPending),
      approve_is_processing: asBoolean(body.approveIsProcessing),
      approve_tx_hash: asString(body.approveTxHash, 160),
      approve_error_details: asJsonObject(body.approveErrorDetails),
      bet_is_pending: asBoolean(body.betIsPending),
      bet_is_processing: asBoolean(body.betIsProcessing),
      bet_tx_hash: asString(body.betTxHash, 160),
      bet_receipt_status: asString(body.betReceiptStatus, 80),
      freebet_id: asString(body.freebetId, 160),
