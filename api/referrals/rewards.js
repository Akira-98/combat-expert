...
import { createPendingReferralReward } from '../_lib/referralRewards.js'
import { fetchReferralShareById } from '../_lib/referralShares.js'
...
export default async function handler(req, res) {
  ...
  try {
    const shareResult = await fetchReferralShareById({
      supabaseUrl,
      serviceRoleKey,
      shareId: req.body?.shareId || req.body?.referralId,
    })
    ...
    return sendServerError(res, error, 'Failed to record referral reward')
  }
}
