  ...
  return h(
    'div',
    {
      style: {
        ...
        height: '100%',
        overflow: 'hidden',
        background: `radial-gradient(circle at 15% 15%, rgba(255, 107, 0, 0.22), transparent 26%), radial-gradient(circle at 82% 28%, rgba(244, 247, 251, 0.08), transparent 22%), linear-gradient(135deg, ${COLORS.bg}, #0b1119 56%, #060708)`,
